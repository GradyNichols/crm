...
const CalendarIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5M8 14h.01M12 14h.01M16 14h.01M8 17h.01M12 17h.01"
    />
  </svg>
);
  ...
  return (
    <div className="min-h-screen bg-[#03060f] text-slate-100">
      ...
      <nav className="pb-4 sm:hidden fixed bottom-0 inset-x-0 z-30 bg-[#03060f]/95 backdrop-blur-sm border-t border-slate-800 flex flex-col">
        ...
        <div
          style={{ height: "env(safe-area-inset-bottom, 40px)" }}
